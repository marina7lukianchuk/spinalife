(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper2")) new Swiper(".swiper2", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".team__slider")) new Swiper(".team__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".team__control-prev",
                nextEl: ".team__control-next"
            }
        });
        if (document.querySelector(".results__slider")) new Swiper(".results__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".results__control-prev",
                nextEl: ".results__control-next"
            },
            breakpoints: {
                768: {
                    slidesPerView: 2,
    ...
    window.onload = function() {
        const el = document.getElementById("preolad");
    ...
    [].forEach.call(document.querySelectorAll('input[type="tel"]'), (function(input) {
        ...
        function mask(event) {
            ...
            var matrix = "+38 0__ ___ __ __", i = 0, def = matrix.replace(/\D/g, ""), val = this.value.replace(/\D/g, ""), new_value = matrix.replace(/[_\d]/g, (function(a) {
